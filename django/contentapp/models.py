...
class Locations(models.TextChoices):
    ...
    ACADEMYFUNDINGCALLSLIFT = "/results/funding-calls?organization=0245893-9&date=2024-11-13|2025-01-08&sort=callDueDesc&search=&typeOfFundingId=2&typeOfFundingId=4&page=1", "Suomen akatemia talvihaku 2024"
...
class SingleFigure(OrderedModelBase):
    ...
    visual_update_date_fi = models.CharField(max_length=100, blank=True)
    visual_update_date_sv = models.CharField(max_length=100, blank=True)
    visual_update_date_en = models.CharField(max_length=100, blank=True)
